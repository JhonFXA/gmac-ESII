...
public class ServicoValidarDocumentacao {
    ...
    public void registrarValidacao(ValidacaoDocumentacaoDTO dto) {
        ...
        Optional<Documentacao> documentacao = repositorioDocumentacao.findById(dto.documentacaoId());
        ...
        atualizarStatusRelacionados(documentacao.get(), dto.status(),usuario,dto.data());
